public class Senador extends Legislador{
    ...
    public Senador(String nombre, String apellido, int edad, boolean booleano, Provincia provincia, String partido, int nro1, int nro2){
        this.nombre=nombre;
    ...
    public Senador(String nombre, String apellido, int edad, boolean booleano, Provincia provincia, int nro1, int nro2){
        this.nombre=nombre;
        this.apellido=apellido;
        this.edad=edad;
        this.booleano=booleano;
